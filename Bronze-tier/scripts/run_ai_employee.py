...
class AIEmployeeRunner:
    ...
    def __init__(self, dry_run: bool = False, verbose: bool = False):
        ...
        self.heartbeat = HeartbeatWriter("run_ai_employee")
    ...
    def run_cycle(self) -> CycleResult:
        ...
        # Update heartbeat with cycle info
    ...
    def run_once(self):
        ...
        self.heartbeat.update_task("single_cycle")
        ...
        # Stop heartbeat
        self.heartbeat.update_task("completed")
        self.heartbeat.stop()
    ...
    def run_daemon(self):
        ...
        # Start heartbeat
        self.heartbeat.start()
        self.heartbeat.update_task("daemon_starting")
        ...
        # Stop heartbeat
        self.heartbeat.update_task("stopped")
        self.heartbeat.stop()
