...
from utils.heartbeat import HeartbeatWriter, HeartbeatContext
...
# Initialize heartbeat writer for watchdog monitoring
...
def run_agent():
    ...
    for metadata_file in metadata_files:
        try:
            ...
            heartbeat_writer.update_task(f"processing:{metadata_file}")
    ...
    # Stop heartbeat
    heartbeat_writer.update_task("completed")
